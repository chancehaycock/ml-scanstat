...
def scan(
    ...
    # Create the Grid
    x_min = grid_dict['x_min']
    x_max = grid_dict['x_max']
    y_min = grid_dict['y_min']
    y_max = grid_dict['y_max']
    t_min = grid_dict['t_min']
    t_max = grid_dict['t_max']
                ...
                for j in range(
                    ...
                    for k, _ in enumerate(y_ticks):  # y_min
                        for l in range(
                            ...
                            asym = ebp_asym(B, C)
                            asym_lower = ebp_asym(B_upper, C)
                            asym_upper = ebp_asym(B_lower, C)
                            ...
                            scores_dict[num_regions] = {
                                ...
                                "l_score_asymEBP_lower": asym_lower,
                                "l_score_asymEBP": asym,
                                "l_score_asymEBP_upper": asym_upper,
                            }
